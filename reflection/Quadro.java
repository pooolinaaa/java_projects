...
public class Quadro implements Transport{
    private String brand;
    private ArrayList<Model> modArr;
    private String type = "Quadro";

    public Quadro(String brand, int size){
        this.brand = brand;
        modArr = new ArrayList<>();
        for (int i = 0;i < size;i++){
            modArr.add(new Model("Quadro" + (i), (int)((i+4)*100*Math.random())));
        }
    }

    public Quadro(String brand) {
        this.brand = brand;
        modArr = new ArrayList<>();
    }
